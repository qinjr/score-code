...
class TargetGen(object):
    ...
    def gen_target_file(self, neg_sample_num, target_file, pred_time, pop_items_file = None):
    ...
    def gen_pop_items(self, pop_items_file, pop_standad):
        pop_items = []
...
if __name__ == '__main__':
    ...
    if dataset == 'ccmr':
        ...
        tg.gen_target_file(NEG_SAMPLE_NUM, DATA_DIR_Taobao + 'target_7.txt', 7, None)
        tg.gen_target_file(NEG_SAMPLE_NUM, DATA_DIR_Taobao + 'target_8.txt', 8, None)
        ...
        tg.gen_target_file(NEG_SAMPLE_NUM, DATA_DIR_Tmall + 'target_10.txt', 10, None)
        tg.gen_target_file(NEG_SAMPLE_NUM, DATA_DIR_Tmall + 'target_11.txt', 11, None)
