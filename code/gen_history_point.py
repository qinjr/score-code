...
if __name__ == "__main__":
    ...
    if dataset == 'CCMR':
        ...
        # Taobao
        gen_user_hist_seq_file(DATA_DIR_Taobao + 'target_16_hot_train.txt', DATA_DIR_Taobao + 'train_user_hist_seq_16.txt', DATA_DIR_Taobao + 'user_hist_dict_16.pkl', MAX_LEN_Taobao)
