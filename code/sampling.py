...
if __name__ == "__main__":
    ...
    if dataset == 'ccmr':
        # CCMR
        sample_files(DATA_DIR_CCMR + 'target_39_hot.txt', 
                    DATA_DIR_CCMR + 'train_user_hist_seq_39.txt', 
                    DATA_DIR_CCMR + 'train_item_hist_seq_39.txt',
                    DATA_DIR_CCMR + 'target_39_hot_sample.txt', 
                    DATA_DIR_CCMR + 'train_user_hist_seq_39_sample.txt', 
                    DATA_DIR_CCMR + 'train_item_hist_seq_39_sample.txt', 
                    2)
        sample_files(DATA_DIR_CCMR + 'target_40_hot.txt', 
                    DATA_DIR_CCMR + 'test_user_hist_seq_40.txt', 
                    DATA_DIR_CCMR + 'test_item_hist_seq_40.txt', 
                    DATA_DIR_CCMR + 'target_40_hot_sample.txt', 
        ...
        sample_files(DATA_DIR_Taobao + 'target_7_hot.txt', 
                    ...
                    DATA_DIR_Taobao + 'target_7_hot_sample.txt', 
                    DATA_DIR_Taobao + 'train_user_hist_seq_7_sample.txt', 
                    DATA_DIR_Taobao + 'train_item_hist_seq_7_sample.txt', 
                    4)
        sample_files(DATA_DIR_Taobao + 'target_8_hot.txt', 
        ...
        sample_files(DATA_DIR_Tmall + 'target_10_hot.txt', 
                    ...
                    1)
        sample_files(DATA_DIR_Tmall + 'target_11_hot.txt', 
                    DATA_DIR_Tmall + 'test_user_hist_seq_11.txt', 
                    DATA_DIR_Tmall + 'test_item_hist_seq_11.txt', 
                    DATA_DIR_Tmall + 'target_11_hot_sample.txt', 
