...
def restore(data_set, target_file_test, graph_handler_params, 
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        logloss, auc, ndcg, loss = eval(model, sess, graph_handler_params, target_file_test, pred_time_test, reg_lambda, user_feat_dict_file, item_feat_dict_file)
...
def train(data_set, target_file_train, target_file_test, graph_handler_params, 
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        step = 0
        test_logloss, test_auc, test_ndcg, test_loss = eval(model, sess, graph_handler_params, target_file_test, pred_time_test, reg_lambda, user_feat_dict_file, item_feat_dict_file)
