...
def draw_ab_study(fig_path='ab_study.pdf'):
    metric_dict = {
        ...
        'RS':     [[0.6896,	0.9066,	0.9452,	0.8091,	0.8217,	0.7841], [0.4598, 0.6704, 0.7431, 0.5713, 0.6032, 0.5662], [0.2309,	0.4786,	0.6212,	0.3397,	0.4015,	0.3523]]
        }

    metric_names = ['HR@1', 'HR@5', 'HR@10', 'NDCG@5', 'NDCG@10', 'MRR']
    labels = ['SCoRe', 'No_Att', '1hop', 'GAT', 'RS']
    color = ['red', 'm', 'orange', 'green', 'blue']
