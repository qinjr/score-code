...
if __name__ == '__main__':
    ...
    if data_set == 'ccmr':
        ...
        target_file_train = DATA_DIR_CCMR + 'target_train_splitbyuser_41.txt'#'target_train.txt'
        target_file_test = DATA_DIR_CCMR + 'target_test_splitbyuser_41.txt'#'target_test_sample.txt'
